...
function load() {
	...
	*/
	...
	bar1.add("图书管理", "添加图书", "<c:url value='/servlet/AdminBookServlet?method=toAdd'/>", "body");

	bar1.add("订单管理", "所有订单", "<c:url value='/servlet/AdminOrderServlet?method=findAll'/>", "body");
	bar1.add("订单管理", "未付款订单", "<c:url value='/servlet/AdminOrderServlet?method=findByState&state=1'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/servlet/AdminOrderServlet?method=findByState&state=2'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/servlet/AdminOrderServlet?method=findByState&state=3'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/servlet/AdminOrderServlet?method=findByState&state=4'/>", "body");
