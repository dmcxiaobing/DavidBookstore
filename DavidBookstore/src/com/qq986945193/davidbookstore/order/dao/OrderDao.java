...
public class OrderDao {
	...
	public void addOrderItemList(List<OrderItem> orderItemList) {
		 ...
		 * 其中params是多个一维数组。每个一维数组斗鱼sql执行一次，多个就执行多次 把一个OrderItem对象转换成一个一维数组
		 */
		try {
	...
	public void loadOrderItems(Order order) throws SQLException {
		...
		/**
		 * mapList是多个map，每个map对应一行结果集 一行： {iid=C7AD5492F27D492189105FB50E55CBB6,
		 * count=2, subtotal=60.0, oid=1AE8A70354C947F8B81B80ADA6783155, bid=7,
		 * bname=精通Hibernate,price=30.0, author=Davidbook,
